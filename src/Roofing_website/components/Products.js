...
function Products() {
  return (
    <div id='products'>
        ...
        <div id='img-boxs'>
        <img src={img1} width={300} height={200} id='img1'/>
        ...
        <div id='img-boxs'>
        <img src={img2} width={300} height={200} id='img1'/>
        <div id='img2-back'></div>
        <h3>Reflective metal roofing</h3>
        </div>
        <div id='img-boxs'>
        <img src={img3} width={300} height={200} id='img1'/>
        <div id='img3-back'></div>
        <h3>Foam Tiles</h3>
        </div>
        <div id='img-boxs'>
        <img src={img4} width={300} height={200} id='img1'/>
        <div id='img4-back'></div>
        <h3>Slate roofing</h3>
        </div>
        <div id='img-boxs'>
        <img src={img5} width={300} height={200} id='img1'/>
        <div id='img5-back'></div>
        <h3>Asphalt Shingles</h3>
        </div>
        <div id='img-boxs'>
        <img src={img6} width={300} height={200} id='img1'/>
        <div id='img6-back'></div>
        <h3>Overlays and Radiant</h3>
        </div>
        </div>
    </div>
  )
